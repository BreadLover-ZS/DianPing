...
>
> 远程开发环境（115.29.220.133/dish_review）的五个迁移脚本均已应用并验证：`20260803`/`20260819`/`20260820` 为历史部署时执行（索引与事件表均已确认存在），`20260821`/`20260822` 于 2026-08-21 执行并逐项验证表结构；迁移前事件表已备份为 `tb_seckill_order_event_bak_20260821`。
