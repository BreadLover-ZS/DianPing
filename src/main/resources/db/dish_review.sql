...
-- ----------------------------
-- Table structure for tb_seckill_order_event
-- ----------------------------
CREATE TABLE IF NOT EXISTS `tb_seckill_order_event` (
  ...
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '0=PENDING，1=CONFIRMED，2=CONSUMED，3=FAILED，4=PUBLISH_UNKNOWN',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='秒杀订单消息事件表';
